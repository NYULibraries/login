module LoginFeatures
  module Admin
    Provider = FactoryGirl.attributes_for(:admin)[:provider]
    def set_admin_login_env
      set_admin_account
      OmniAuth.config.mock_auth[Provider.to_sym] = admin_omniauth_hash
    end
    ...
    def login_as_admin
      follow_login_steps_for_location provider_to_location[Provider]
    end
