...
#
#             it { should be_redirect }
#             it { should redirect_to "/login/#{inst}?redirect_to=%2Fezborrow%2F#{inst}" }
#           end
#         end
#       end
#
...
#
#         it { should be_redirect }
#         it { should redirect_to '/login/nyu?redirect_to=%2Fezborrow%3Fquery%3Dthe%2Bastd%2Bmanagement%2Bdevelopment%2Bhandbook' }
#       end
#     end
#
