module Login
  module Aleph
    class Patron
      ...
      def to_h
        @to_h = ActiveSupport::HashWithIndifferentAccess.new(instance_values)
      end
      alias_method :attributes, :to_h

      def institution_for_ill_library
        ILL_LIBRARY_MAPPINGS.find do |institution_code, ill_libraries|
      ...
      def institution_for_bor_status
        BOR_STATUS_MAPPINGS.find do |institution_code, bor_statuses|
